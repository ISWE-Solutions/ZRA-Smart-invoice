...
#
#
# class CustomDebitNote(models.TransientModel):
...
#         super(CustomDebitNote, self).create_debit()
#         self._process_moves()
#
...
#             return 0.0  # Return 0 if there's no product associated
#
#         product = self.env['product.product'].browse(line.product_id.id)
#         product_template = product.product_tmpl_id  # Fetch the product template
#
#         itemCd = product_template.item_Cd or ""
#         itemClsCd = product_template.item_cls_cd or ""
#         pkgUnitCd = product_template.packaging_unit_cd or ""
#         qtyUnitCd = product_template.quantity_unit_cd or ""
#
#         # Ensure all required fields are present before calculating tax inclusive price
#         if not (itemCd and itemClsCd and pkgUnitCd and qtyUnitCd):
#             raise ValueError("Missing required data for tax calculation.")
#
...
#                 "dbtRsnCd": self.reason,
#                 "invcAdjustReason": "",
#                 "itemList": [
#                     {
#                         "itemSeq": index + 1,
#                         "itemCd": line.product_id.item_Cd or itemCd,
#                         "itemClsCd": line.product_id.item_cls_cd or itemClsCd,
#                         "itemNm": line.product_id.name,
#                         "bcd": line.product_id.barcode,
#                         "pkgUnitCd": line.product_id.packaging_unit_cd or pkgUnitCd,  # Example static value, can be dynamic
#                         "pkg": line.quantity,
#                         "qtyUnitCd": line.product_id.quantity_unit_cd or qtyUnitCd,
#                         "qty": line.quantity,
...
#                     print(
#                         f"Product {product.name} - itemCd: {itemCd}, itemClsCd: {itemClsCd}, pkgUnitCd: {pkgUnitCd}, qtyUnitCd: {qtyUnitCd}")
#
#                     item_list.append({
#                         "itemSeq": index + 1,
#                         "itemCd": itemCd,
...
#                     })
#                 else:
#                     # Log error if product_id is missing
#                     _logger.error(f"Product ID missing for line: {line.id}")
#
...
#                 "orgSarNo": 0,
#                 "regTyCd": "M",
#                 "custTpin": move.partner_id.tpin if move.partner_id else None,
...
#                         "itemCd": product_template.item_Cd,  # From product template

...
class AccountMoveReversal(models.TransientModel):
    ...
    def refund_move(self):
        res = super(AccountMoveReversal, self).refund_moves()

        # Post a message in the chatter
        try:
            move = self.env['account.move'].browse(self.move_id.id)
            move.message_post(body="Refund move has been created.")
            print('Refund move message posted successfully')
        except Exception as e:
            print(f"Error posting refund move chatter message: {e}")

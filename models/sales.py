...
class AccountMove(models.Model):
    ...
    def generate_sales_payload(self):
        ...
        payload = {
            ...
            "taxblAmtA": round(self.calculate_taxable_amount(self.invoice_line_ids, 'A'), 2),
            "taxblAmtB": round(self.calculate_taxable_amount(self.invoice_line_ids, 'B'), 2),
            "taxblAmtC": round(self.calculate_taxable_amount(self.invoice_line_ids, 'C'), 2),
            "taxblAmtC1": round(self.calculate_taxable_amount(self.invoice_line_ids, 'C1'), 2),
            "taxblAmtC2": round(self.calculate_taxable_amount(self.invoice_line_ids, 'C2'), 2),
            "taxblAmtC3": round(self.calculate_taxable_amount(self.invoice_line_ids, 'C3'), 2),
            "taxblAmtD": round(self.calculate_taxable_amount(self.invoice_line_ids, 'D'), 2),
            "taxblAmtRvat": round(self.calculate_taxable_amount(self.invoice_line_ids, 'RVAT'), 2),
            "taxblAmtE": round(self.calculate_taxable_amount(self.invoice_line_ids, 'E'), 2),
            "taxblAmtF": round(self.calculate_taxable_amount(self.invoice_line_ids, 'F'), 2),
            "taxblAmtIpl1": round(self.calculate_taxable_amount(self.invoice_line_ids, 'Ipl1'), 2),
            "taxblAmtIpl2": round(self.calculate_taxable_amount(self.invoice_line_ids, 'Ipl2'), 2),
            "taxblAmtTl": round(self.calculate_taxable_amount(self.invoice_line_ids, 'Tl'), 2),
            "taxblAmtEcm": round(self.calculate_taxable_amount(self.invoice_line_ids, 'Ecm'), 2),
            "taxblAmtExeeg": round(self.calculate_taxable_amount(self.invoice_line_ids, 'Exeeg'), 2),
            "taxblAmtTot": round(self.calculate_taxable_amount(self.invoice_line_ids, 'Tot'), 2),
            "taxRtA": 16,
            "taxRtB": 16,
            "taxRtC1": 0.0,
            "taxRtC2": 0.0,
            ...
            "taxRtExeeg": 3,
            "taxRtTot": 0.0,
            "taxAmtA": round(self.calculate_tax_amount(self.invoice_line_ids, 'A'), 2),
            "taxAmtB": round(self.calculate_tax_amount(self.invoice_line_ids, 'B'), 2),
            "taxAmtC": round(self.calculate_tax_amount(self.invoice_line_ids, 'C'), 2),
            "taxAmtC1": round(self.calculate_tax_amount(self.invoice_line_ids, 'C1'), 2),
            "taxAmtC2": round(self.calculate_tax_amount(self.invoice_line_ids, 'C2'), 2),
            "taxAmtC3": round(self.calculate_tax_amount(self.invoice_line_ids, 'C3'), 2),
            "taxAmtD": round(self.calculate_tax_amount(self.invoice_line_ids, 'D'), 2),
            "taxAmtRvat": round(self.calculate_tax_amount(self.invoice_line_ids, 'Rvat'), 2),
            "taxAmtE": round(self.calculate_tax_amount(self.invoice_line_ids, 'E'), 2),
            "taxAmtF": round(self.calculate_tax_amount(self.invoice_line_ids, 'F'), 2),
            "taxAmtIpl1": round(self.calculate_tax_amount(self.invoice_line_ids, 'Ipl1'), 2),
            "taxAmtIpl2": round(self.calculate_tax_amount(self.invoice_line_ids, 'Ipl2'), 2),
            "taxAmtTl": round(self.calculate_tax_amount(self.invoice_line_ids, 'Tl'), 2),
            "taxAmtEcm": round(self.calculate_tax_amount(self.invoice_line_ids, 'Ecm'), 2),
            "taxAmtExeeg": round(self.calculate_tax_amount(self.invoice_line_ids, 'Exeeg'), 2),
            "taxAmtTot": round(self.calculate_tax_amount(self.invoice_line_ids, 'Tot'), 2),
